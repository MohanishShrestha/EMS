  ...
  return (
    <Grid container spacing={2}>
      ...
      <Grid item xs={12} md={6}>
        <Paper sx={{ ml: -3, pt: 6, pr: 27, pb: 8.5, pl: 9, position: "relative", overflow: "hidden" }}>
          <Box sx={{ position: "absolute", top: 24, right: 24, backgroundColor: "#3498db", borderRadius: "12px", p: 1.5, display: "flex", alignItems: "center", justifyContent: "center" }}>
            <PeopleIcon sx={{ color: "white", fontSize: 60 }} />
          </Box>
          <Typography variant="h6" color="text.secondary">Total Employees</Typography>
          <Typography variant="h3" sx={{ fontWeight: "bold", color: "#2c3e50", my: 1 }}>{totalEmployees}</Typography>
          <Typography variant="body2" sx={{ color: "#2ecc71", display: "flex", alignItems: "center" }}>
      ...
      {/* Working Today */}
      <Grid item xs={12} md={6}>
        <Paper sx={{ pt: 6, pr: 27, pb: 6, pl: 9, position: "relative", overflow: "hidden" }}>
          <Box sx={{ position: "absolute", top: 16, right: 16, backgroundColor: "#2ecc71", borderRadius: "12px", p: 1.5, display: "flex", alignItems: "center", justifyContent: "center" }}>
            <CheckCircleIcon sx={{ color: "white", fontSize: 60 }} />
          </Box>
          <Typography variant="h6" color="text.secondary">Working Today</Typography>
          <Typography variant="h3" sx={{ fontWeight: "bold", color: "#2c3e50", my: 1 }}>{workingToday}</Typography>
